        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo base_url();?>/index.php/Hospital/object">
                        
                       <h1>Se ha registrado tu consulta</h1>
                        
                    </form>
                </div>
                <div class="p-t-15">
                    <button  class="btn btn--radius-2 btn--white" type="submit">
                    <a class="boton"href="consulta"><strong>Regresar</strong></a>
                    </button>
                 </div>
            </div>
        </div>
