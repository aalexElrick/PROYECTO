    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Has terminado</h2>
                    <form method="POST" action="<?php echo base_url();?>/index.php/Hospital/objectForo">
                        
                       <h1>Se ha registrado tu pregunta</h1>
                       <h3>Se contestara pronto tu duda!</h3>
                        
                    </form>
                </div>
                <div class="p-t-15">
                    <button  class="btn btn--radius-2 btn--white" type="submit">
                    <a class="boton"href="foro"><strong>Regresar</strong></a>
                    </button>
                 </div>
            </div>
        </div>
